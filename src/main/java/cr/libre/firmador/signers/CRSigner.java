...
public class CRSigner {
	...
	private static String detectJCOP4PKCS11Lib() {
		String pathloc = null;
		String osName = System.getProperty("os.name").toLowerCase();
		if (osName.contains("mac"))
			pathloc = "/Library/SCMiddleware/libidop11.dylib";
		else if (osName.contains("linux"))
			pathloc = "/usr/lib/SCMiddleware/libidop11.so";
		else if (osName.contains("windows"))
			pathloc = System.getenv("PROGRAMFILES") + "\\Smart Card Middleware\\bin\\idoPKCS.dll";
		if (pathloc != null) {
    ...
    public static String getPkcs11Lib() {
		...
		String jcop4 = detectJCOP4PKCS11Lib();
		if (jcop4 != null)
			return jcop4;
    ...
    public CertificateVerifier getCertificateVerifier() {
        ...
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/CA POLITICA PERSONA FISICA - COSTA RICA v2(1).crt")));
        ...
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/CA POLITICA PERSONA JURIDICA - COSTA RICA v2(1).crt")));
        ...
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/CA POLITICA SELLADO DE TIEMPO - COSTA RICA v2(1).crt")));
        ...
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/CA SINPE - PERSONA FISICA v2(3).crt")));
        ...
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/CA SINPE - PERSONA JURIDICA v2(3).crt")));
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/TSA SINPE v3.crt")));
        adjunctCertSource.addCertificate(DSSUtils.loadCertificate(this.getClass().getClassLoader().getResourceAsStream("certs/TSA SINPE v4.crt")));
    ...
    public CertificateVerifier getCertificateVerifier(CertificateToken subjectCertificate) {
		...
		certmanager.loadCertifcatesSources();
