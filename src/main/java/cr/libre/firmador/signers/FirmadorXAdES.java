...
public class FirmadorXAdES extends CRSigner implements DocumentSigner {
	...
	public FirmadorXAdES(GUIInterface gui, boolean xmlcontent) {
        super(gui);
        // FIXME check if this call is required if variable is unused
	...
	public FirmadorRemoteDocument getTobeSignedRemote(Document toSignDocument, CardSignInfo card) {
		...
		remoteservice.setXadesService(service);
