...
public class CertificateManager {
    ...
    public void loadCertifcatesSources() {
        ...
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA POLITICA PERSONA FISICA - COSTA RICA v2(1).crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA POLITICA PERSONA JURIDICA - COSTA RICA v2.crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA POLITICA PERSONA JURIDICA - COSTA RICA v2(1).crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA POLITICA SELLADO DE TIEMPO - COSTA RICA v2.crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA POLITICA SELLADO DE TIEMPO - COSTA RICA v2(1).crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
        ...
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA SINPE - PERSONA FISICA v2(3).crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
        ...
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/CA SINPE - PERSONA JURIDICA v2(3).crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/TSA SINPE v3.crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
                loaderclass.getResourceAsStream("certs/TSA SINPE v4.crt")));
        certSource.addCertificate(DSSUtils.loadCertificate(
    ...
    public List<X509Certificate> getCertificateChainTSA() throws CertificateException {
        ...
        CertificateToken tsa_sinpe = DSSUtils
                .loadCertificate(loaderclass.getResourceAsStream("certs/TSA SINPE v4.crt"));
